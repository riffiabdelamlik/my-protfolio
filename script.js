...
const categories = [
  ...
  {
    slug:"ui-design", label:"Profile Information", icon:"◉",
    tagline:"Clean UI layouts and profile components.",
    image:"https://images.unsplash.com/photo-1545665277-5937489579f2?auto=format&fit=crop&w=600&q=80",
    desc:"A clean, responsive profile layout showcasing semantic HTML and layout skills.",
    projects:[
      { title:"Profile Card Component", tags:["HTML","CSS"], link:"https://riffiabdelamlik.github.io/my-protfolio/profile.html", image:"https://images.unsplash.com/photo-1545665277-5937489579f2?auto=format&fit=crop&w=600&q=80" },
      { title:"Dashboard UI", tags:["HTML","CSS"], link:"https://riffiabdelamlik.github.io/my-protfolio/", image:"https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=600&q=80" },
      { title:"Pricing Table", tags:["HTML","CSS"], link:"https://riffiabdelamlik.github.io/my-protfolio/", image:"https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=80" },
  ...
  {
    slug:"functionality", label:"Interactive Contact", icon:"◇",
    tagline:"JavaScript-powered interactive pages.",
    image:"https://images.unsplash.com/photo-1534536281715-e28d76689b4d?auto=format&fit=crop&w=600&q=80",
    desc:"A professional contact page with JS validation and real-time email delivery.",
    projects:[
      { title:"Contact Form + Validation", tags:["HTML","CSS","JS"], link:"https://riffiabdelamlik.github.io/my-protfolio/contact.html", image:"https://images.unsplash.com/photo-1534536281715-e28d76689b4d?auto=format&fit=crop&w=600&q=80" },
      { title:"FAQ Accordion", tags:["HTML","CSS","JS"], link:"https://riffiabdelamlik.github.io/my-protfolio/", image:"https://images.unsplash.com/photo-1516321497487-e288fb19713f?auto=format&fit=crop&w=600&q=80" },
